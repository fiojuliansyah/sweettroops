<div class="top-navbar flex-between gap-16">
    ...
    <div class="flex-align gap-16">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-24 max-h-270 overflow-y-auto scroll-sm">
                                <div class="d-flex align-items-start gap-12">
                                    <img src="/admin/assets/images/thumbs/notification-img1.png" alt=""
                                    ...
                                    <div class="border-bottom border-gray-100 mb-24 pb-24">
                                        ...
                                        <div class="flex-align gap-6 mt-8">
                                            <img src="/admin/assets/images/icons/google-drive.png"
                                                alt="">
                                            <div class="flex-align gap-4">
                                ...
                                <div class="d-flex align-items-start gap-12">
                                    <img src="/admin/assets/images/thumbs/notification-img2.png"
        ...
        <!-- User Profile Start -->
        @guest
            <a class="btn btn-main rounded-pill py-9 buy-course" href="{{ route('login-phone') }}">Login</a>
        @endguest
        ...
        @auth
            <div class="dropdown">
                <button
                    ...
                    type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="position-relative">
                        <img src="/admin/assets/images/thumbs/user-img.png" alt="Image"

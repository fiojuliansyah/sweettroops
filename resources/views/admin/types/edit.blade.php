...
<div class="dashboard-body">
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-gray-500 fw-normal d-flex"><i class="ph ph-caret-right"></i></span></li>
                <li><span class="text-main-600 fw-normal text-15">Edit Type</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Edit Type: {{ $type->name }}</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('admin.types.update', $type) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" value="{{ $type->slug }}" disabled readonly>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-main">
                        <i class="ph ph-check-circle me-2"></i> Update Type
                    </button>

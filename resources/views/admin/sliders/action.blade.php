{{-- resources/views/admin/sliders/action.blade.php --}}
<div>
    <a href="{{ route('admin.sliders.edit', $query->id) }}" class="bg-warning-50 text-warning-600 py-2 px-14 rounded-pill hover-bg-warning-600 hover-text-white">
        Edit
    </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete the slider <strong>{{ $query->title }}</strong>?</p>
                <p class="text-danger">This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('admin.sliders.destroy', $query->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')

...
<div>
    <a href="{{ route('admin.videos.edit', [$query->course_id, $query->id]) }}" class="btn btn-warning rounded-pill">
        Edit
    </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete the video <strong>{{ $query->title }}</strong>?</p>
                <p class="text-danger">This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('admin.videos.destroy', $query->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')

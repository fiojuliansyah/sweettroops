...
@section('content')
  ...
  <div class="spark-section">
    <div class="spark-container w-container">
      <p class="spark-secondary-paragraph">Got questions? You&#x27;re not alone.<br>We&#x27;ve gathered the ones we hear most from our students and customers to help you find answers quickly - so you can spend less time wondering, and more time whisking, baking, and create something sweet.<br>Let&#x27;s get back to baking!</p>
      <div data-hover="false" data-delay="250" data-w-id="7ab01c1b-7e6b-6729-b326-4bdf16213529" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
          </div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="7ab01c1b-7e6b-6729-b326-4bdf16213533" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="7ab01c1b-7e6b-6729-b326-4bdf1621353d" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="5bdb1dec-a12b-b92f-fbcb-2b7c4180f4fd" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="7a3a0c8a-c587-7bcb-e363-6dbe4941e5cc" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="bc33771d-bb62-134b-0880-a4d41d86b0a2" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="5dda6544-c1b7-8943-56af-4d3fa43180d9" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>
      ...
      <div data-hover="false" data-delay="250" data-w-id="93120b13-531c-6e0e-bcc3-b9dca1b43649" class="spark-faq-expander w-dropdown">
        <div class="spark-faq-button w-dropdown-toggle">
          <div class="spark-faq-plus-to-x">
            <div class="spark-horizontal-line"></div>
            <div class="spark-vertical-line"></div>

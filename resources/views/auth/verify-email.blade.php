...
<section class="auth d-flex">
    ...
    <div class="auth-right py-40 px-24 flex-center flex-column">
        <div class="auth-right__inner mx-auto w-100">
            ...
            <p class="text-gray-600 text-15 mb-32">We sent a verification code to your email. Enter the code from the email in the field below. 
                <span class="fw-medium d-block">***{{ substr($user->email, -6) }}</span>
            </p>
            ...
            <form action="{{ route('verify.otp.email') }}" method="POST">
                @csrf
                <div class="mb-32">
            ...
            <p class="mt-24 text-gray-600 text-center">Didn't get the code?
                ...
                <form id="resend-form" action="{{ route('esend.otp.email') }}" method="POST" class="d-none">
                    @csrf
                </form>
            </p>
        </div>
